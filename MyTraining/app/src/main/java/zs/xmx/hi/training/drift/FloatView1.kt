...
class FloatView1 {
    ...
    private var floatView =
        LayoutInflater.from(application).inflate(R.layout.layout_float_view, null, false) as View
    ...
    fun getAnimation(): Animation {
        val animation = ScaleAnimation(
            0.0f, 1f, 0.0f, 1f,
            Animation.ABSOLUTE, 100f, Animation.ABSOLUTE, 100f
        )
